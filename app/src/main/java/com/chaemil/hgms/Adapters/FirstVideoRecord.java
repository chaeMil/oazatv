...
public class FirstVideoRecord {
    ...
    public FirstVideoRecord(String type, String thumb, String title, String videoDate, String videoURL, String albumId, String videoViews, String thumbBlur) {
        this.thumb = thumb;
        this.title = title;
