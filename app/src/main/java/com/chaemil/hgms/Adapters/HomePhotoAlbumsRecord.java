 ...
 */
public class HomePhotoAlbumsRecord {
    public String thumb;
    public String title;
    ...
    public HomePhotoAlbumsRecord(String type, String thumb, String title, String videoDate, String videoURL, String albumId, String videoViews, String thumbBlur) {
        this.thumb = thumb;
        this.title = title;
